...
<body>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "WebForm1.aspx/GetCountries",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
            ...
            $("#stateid").change(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "WebForm1.aspx/GetDistricts",
            ...
            $("#submitid").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "WebForm1.aspx/InsertUserData",
            ...
            $(document).on('click', '.edit-btn', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "WebForm1.aspx/GetUserForEdit",
