...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Apiproject.aspx.cs" Inherits="month3.Apiproject" %>
    ...
    <script>
        ...
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.d === "Success") {
                            Swal.fire("Success", "Units updated!", "success");
            ...
            function automatic() {
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        alert("Error loading user data: " + error + xhr.responseText);
                    }
                })
            }
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.d && !response.d.startsWith("Error")) {
                            Swal.fire("Success", response.d, "success");
                            $('#editModal').modal('hide');
                        } else {
                            Swal.fire("Error", response.d || "Update failed", "error");
                        }
                    },
                    error: function (xhr, status, error) {
            ...
            function updateRowColor(row, unitsValue) {
                ...
                //userTable.row(row).invalidate().draw();
            ...
            $.ajax({
                type: "POST",
                url: "project8.aspx/GetCountries",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {

                    const countries = response.d;
                    const countryDropdown = $("#countryid");
                    countryDropdown.empty().append(new Option("Select Country", ""));


                    $.each(countries, function (i, c) {
                        countryDropdown.append(new Option(c.Name, c.Id));
                    });
            ...
            $("#countryid").change(function () {
                const countryId = parseInt($(this).val()); // must be integer
                ...
                $.ajax({
                    type: "POST",
                    url: "project8.aspx/GetStates",
                    data: JSON.stringify({ countryId: countryId }), 
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        const states = response.d;
                        $.each(states, function (i, s) {
                            stateDropdown.append(new Option(s.Name, s.Id));
                        });
                    },
                    error: function (xhr) {
            ...
            $("#stateid").change(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "project8.aspx/GetDistricts",
                    data: JSON.stringify({ stateId: stateId }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        debugger
                        const district = response.d;
                        $.each(district, function (i, d) {
                            districtDropdown.append(new Option(d.Name, d.Id));
                        });
                    },
                    error: function (xhr, status, error) {
            ...
            $("#submitid").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "project8.aspx/InsertUserData",
            ...
            $(document).on('click', '.edit-btn', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "project8.aspx/GetUserForEdit",
                    ...
                    success: function (response) {
                        ...
                        //$('#editSubmittedDateTime').val(user.submittedDateTime);
            ...
            $(document).on('click', '.delete-btn', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",  
                            url: "project8.aspx/DeleteUser", 
                            data: JSON.stringify({ userId: userId }),  
                            contentType: "application/json; charset=utf-8",  
                            dataType: "json", 
                            success: function (response) {
                                if (response.d === "User deleted successfully!") {
                                    ...
                                    Swal.fire(
                                        'Error!',
                                        'There was an issue deleting the user: ' + response.d,
                                        'error'
                                    );
                                }
                            },
                            error: function (xhr, status, error) {
                                Swal.fire(
                                    'Error!',
                                    'There was an error with the request: ' + error,
                                    'error'
                                );
                            }
                        });
