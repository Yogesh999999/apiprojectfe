<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="apiproject2.aspx.cs" Inherits="project7.apiproject2" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", ".saveclass", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "apiproject.aspx/PatchUnits",
                    data: JSON.stringify({
                        id: parseInt(userId),
                        units: unitsValue
                    }),
            ...
            $.ajax({
                type: "POST",
                url: "apiproject.aspx/GetCountries",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
            ...
            $("#stateid").change(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "apiproject.aspx/GetDistricts",
            ...
            $("#submitid").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "apiproject.aspx/InsertUserData",
            ...
            $(document).on('click', '.edit-btn', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "apiproject.aspx/GetUserForEdit",
            ...
            $(document).on('click', '.delete-btn', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",  
                            url: "apiproject.aspx/DeleteUser", 
                            data: JSON.stringify({ userId: userId }),  
                            contentType: "application/json; charset=utf-8",  
                            dataType: "json", 
                            success: function (response) {
